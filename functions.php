...
{
  $length = mb_strlen($string, 'UTF-8'); //文字列の長さを取得
  if ($length < $maxLength) {
    return $string;
  } else {
...
function breadcrumb($postID)
{
  ...
  if (is_single()) {
    //詳細ページの場合
    echo '<li class="breadcrumb-item"><a href="/">トップ &ensp;</a></li>';
    echo '<li>> &ensp;</li>';
    echo '<li class="breadcrumb-item"><a href="/blog/">event &ensp;</a></li>';
    echo '<li>> &ensp;</li>';
